...
class FavoriteDaoTest {
    ...
    @Test
    fun insertFavorite_adds_a_favorite_entity() = runTest {
        // When
    ...
    @Test
    fun deleteFavorite_removes_the_entity() = runTest {
        // Given
        dao.insertFavorite(FavoriteEntity("venue-1"))
    ...
    @Test
    fun getAllFavorites_returns_all_inserted_favorites() = runTest {
        // Given
        dao.insertFavorite(FavoriteEntity("venue-1"))
