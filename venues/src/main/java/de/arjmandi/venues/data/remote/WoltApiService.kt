...
class WoltApiService(private val client: HttpClient) {

    suspend fun getVenues(lat: Double, lon: Double): ApiResult<VenueResponseDto> {
        return try {
            val response: HttpResponse = client.get("https://restaurant-api.wolt.com/v1/pages/restaurants") {
                url {
